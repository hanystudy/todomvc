...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoContainer = __webpack_require__(164);
	...
	var _todoOperations = __webpack_require__(186);

	var _todoOperations2 = _interopRequireDefault(_todoOperations);
	...
	var store = (0, _redux.createStore)(_todoOperations2.default, { data: data });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoInput = function (_Component) {
	  ...
	  function TodoInput(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoInput).call(this, props));
	  }
	  ...
	  _createClass(TodoInput, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { type: 'text', ref: 'newTodoText', placeholder: 'what needs to be done?' }),
	  ...
	  _createClass(TodoList, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'ul',
	        null,
	        this.props.todoData.map(function (item, index) {
	          return _react2.default.createElement(_todoItem2.default, { text: item.text, index: index, complete: item.complete, key: index, handleToggle: function handleToggle(index) {
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement("input", { type: "checkbox", checked: this.props.complete, onChange: function onChange() {
	            return _this2.props.handleToggle(_this2.props.index);
	          } }),
	        _react2.default.createElement(
	          "div",
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoStatusBar = function (_Component) {
	  _inherits(TodoStatusBar, _Component);

	  function TodoStatusBar() {
	    _classCallCheck(this, TodoStatusBar);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoStatusBar).apply(this, arguments));
	  }

	  _createClass(TodoStatusBar, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	  ...
	  return TodoStatusBar;
	}(_react.Component);

	exports.default = TodoStatusBar;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoStatusBar = __webpack_require__(163);

	var _todoStatusBar2 = _interopRequireDefault(_todoStatusBar);
	...
	var TodoContainer = function (_Component) {
	  ...
	  function TodoContainer(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(TodoContainer).call(this, props));
	  }
	  ...
	  _createClass(TodoContainer, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_todoInput2.default, { appendTodo: function appendTodo(todo) {
	            return _this2.props.actions.appendTodo(todo);
	          } }),
	        _react2.default.createElement(_todoList2.default, { todoData: this.props.data, handleToggle: function handleToggle(index) {
	            return _this2.props.actions.handleToggle(index);
	          } }),
	        _react2.default.createElement(_todoStatusBar2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	exports.default = todoOperations;

	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

	function todoOperations(state, action) {
	  switch (action.type) {
	    case 'APPEND_TODO':
	      return { data: [].concat(_toConsumableArray(state.data), [{
	          text: action.text,
	          complete: false
	        }]) };
	    case 'TOGGLE_TODO':
	      var newTodos = Object.assign([], state.data);
